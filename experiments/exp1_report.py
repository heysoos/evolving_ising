...
_CSS = """
body { font-family: Georgia, serif; max-width: 1100px; margin: 0 auto; padding: 2em;
       color: #222; background: #fafafa; }
h1 { color: #1a3a5c; border-bottom: 2px solid #1a3a5c; padding-bottom: 0.3em; }
h2 { color: #2c5282; margin-top: 1.8em; }
h3 { color: #2d3748; }
.card { background: #fff; border: 1px solid #cbd5e0; border-radius: 6px;
        padding: 1.2em 1.6em; margin: 1em 0; box-shadow: 0 1px 4px rgba(0,0,0,.06); }
.highlight { background: #ebf8ff; border-left: 4px solid #3182ce; padding: .5em 1em; }
table { border-collapse: collapse; width: 100%; font-size: 0.88em; margin-top: 0.8em; }
...
img.fig   { max-width: 100%; border: 1px solid #e2e8f0; border-radius: 4px;
            margin: 0.8em 0; box-shadow: 0 2px 6px rgba(0,0,0,.08); }
.formula  { font-family: 'Courier New', monospace; background: #f7fafc;
            border: 1px solid #e2e8f0; padding: .3em .7em; border-radius: 4px; }
.caption  { font-style: italic; color: #4a5568; margin: -0.3em 0 1em 0;
            font-size: 0.92em; }
